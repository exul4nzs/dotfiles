# Generated by Powerlevel10k configuration wizard on 2025-08-06 at 11:49 PST.
...
# angled separators, sharp heads, round tails, 2 lines, solid, right frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND=56
  ...
  function my_git_formatter() {
    ...
    local   modified='%6F' # dim blue foreground
    local  untracked='%15F' # white foreground
    local conflicted='%15F' # red foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=47
  ...
  typeset -g POWERLEVEL9K_TIME_BACKGROUND=92
  # Format for the current time: 09:51:02. See `man 3 strftime`.
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%I:%M:%S %p}'
  typeset -g POWERLEVEL9K_TIME_SHOW_HISTORY=false       # ← This actually disables N.H.
  # If set to true, time will update when you hit enter. This way prompts for the past
  # commands will contain the start times of their commands as opposed to the default
  # behavior where they contain the end times of their preceding commands.
  typeset -g POWERLEVEL9K_TIME_UPDATE_ON_COMMAND=false
  # Disable history indicator in the time segment
 # Custom icon.

...
end, { desc = "Horizontal Terminal (Closable)" })

-- Vertical terminal (closable)
vim.keymap.set("n", "<leader>Tv", function()
  vim.cmd("vsplit term://$SHELL")
  vim.cmd("startinsert")
end, { desc = "Vertical Terminal (Closable)" })
...
-- Normal Mode
vim.keymap.set('n', '<C-BS>', 'vb"_d', { desc = "Delete previous word" })
vim.keymap.set('n', '<A-BS>', 'vb"_d', { desc = "Delete previous word (Alt)" })

-- Insert Mode
vim.keymap.set('i', '<C-BS>', '<C-w>', { desc = "Delete previous word" })
vim.keymap.set('i', '<A-BS>', '<C-w>', { desc = "Delete previous word (Alt)" })
